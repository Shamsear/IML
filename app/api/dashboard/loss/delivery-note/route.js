...
const LossNoteDocument = ({ brandName, inventory, dateStr, docNo, notes }) => {
      ...
      <Page size="A4" style={pdfStyles.page}>
        <View style={pdfStyles.outerContainer}>
          <View style={pdfStyles.topSection}>
            {/* Title */}
            <Text style={pdfStyles.docTitle}>LOSS NOTE</Text>
  ...
  try {
    ...
    return new NextResponse(pdfStream, {
      headers: {
        ...
        'Content-Disposition': `inline; filename="IML-LossNote-${brandName.replace(/\s+/g, '_')}.pdf"`,
      },
    });
