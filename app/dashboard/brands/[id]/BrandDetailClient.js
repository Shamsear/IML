        ...
        <div className="flex items-center gap-4">
          ...
          {brand.imageUrl ? (
            <img 
              ...
              alt={brand.name} 
              className="w-12 h-12 rounded-xl object-cover border border-border flex-shrink-0 cursor-pointer hover:border-primary transition-all shadow-sm"
                ...
                <div key={product.id} className="bg-surface border border-border rounded-xl p-4 flex flex-col gap-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      {product.imageUrl ? (
                        <img src={getOptimizedImageUrl(product.imageUrl, 80, 80)} alt={product.name} className="w-10 h-10 rounded-lg object-cover border border-border flex-shrink-0 cursor-zoom-in hover:brightness-95 transition-all duration-200" onClick={() => setLightboxImage({ url: product.imageUrl, name: product.name })} />
                      ) : (
