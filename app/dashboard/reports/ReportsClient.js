                      ...
                      <div className="flex items-center gap-3">
                        {p.imageUrl ? (
                          <img 
                            ...
                            alt={p.name} 
                            className="w-8 h-8 rounded-md object-cover border border-border flex-shrink-0 cursor-zoom-in hover:brightness-95 transition-all duration-200 print:w-6 print:h-6"
