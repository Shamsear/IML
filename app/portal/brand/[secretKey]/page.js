  ...
  if (!brand) {
    return (
      <div className="min-h-[100dvh] bg-[#fcfbfa] flex flex-col items-center justify-center p-6 text-center font-sans">
        ...
        <h2 className="text-xl font-display font-extrabold text-text-primary mb-2">Portal Access Denied</h2>
        <p className="text-sm text-text-secondary max-w-sm leading-relaxed">
          The link you followed is invalid, expired, or the secret key was changed. Please contact the warehouse administrator to request a new partner access link.
        </p>
      </div>
    );
  }
