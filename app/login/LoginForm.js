...
import { Lock, User, Loader2, Eye, EyeOff, HelpCircle } from 'lucide-react';
...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-background animate-fade-in">
      ...
      <div className="flex-1 bg-surface flex flex-col items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-[360px] flex flex-col gap-6">
          ...
          <div className="flex items-center justify-center gap-1.5 text-2xs text-text-muted border-t border-border pt-4 mt-1">
          ...
          <div className="md:hidden flex flex-col gap-4 mt-4 pt-4 border-t border-border/60 text-center">
