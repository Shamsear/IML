...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      {/* Left Branding Panel */}
      <div className="w-full md:w-[40%] bg-gradient-to-br from-primary/10 via-background to-secondary/5 border-r border-border p-8 md:p-12 flex flex-col justify-between">
        ...
        <div className="text-xs text-text-muted mt-8 text-center md:text-left">
          <span>© {new Date().getFullYear()} The IML Group. All rights reserved.</span>
        </div>
      </div>

      {/* Right Form Panel */}
      <div className="flex-1 bg-surface flex items-center justify-center p-8 sm:p-12">
